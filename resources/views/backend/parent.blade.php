      ...
      <div class="ms-auto">
        <ul class="list-unstyled">
          ...
          <li class="dropdown pc-h-item">
            <a class="pc-head-link head-link-secondary dropdown-toggle arrow-none me-0" href="{{url('qrcode-scanner')}}">
...
function editJobdesc(data)
{
    ...
    $('#jobdescForm input[name="name"]')
        .val(data.name);

    $('#jobdescForm select[name="is_active"]')
        .val(data.is_active);
