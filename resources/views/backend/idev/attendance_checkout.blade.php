...
<body>
    <div class="attendance-card">
        ...
        <h3 class="fw-bold text-dark mb-2">Training Checkout</h3>
        <p class="text-muted mb-4">Silahkan pindai kode QR ini untuk mencatat waktu (selesai) pelatihan anda.</p>
        ...
        <div class="qr-code-section">
            ...
            <p class="mt-3 fw-bold text-primary">Scan untuk Memulai!</p>
        </div>
