            ...
            <div class="card">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <h3 class="fw-bold text-dark">Menyimpan waktu (selesai) pelatihan</h3>
                        @if($data_query->attendance?->date_out_present)
                    ...
                    <p class="mt-2 text-muted">Pelatihan {{ $eventName }} telah selesai. Mohon konfirmasi waktu (selesai) Anda.</p>
                    <hr class="my-4">
...
<script>
  ...
  var url = "/participant-checkout/" + token;
