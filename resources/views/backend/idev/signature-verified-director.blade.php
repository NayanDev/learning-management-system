                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <h6 class="text-uppercase fw-bold section-title mb-4 border-bottom pb-2">
                            <i class="fas fa-user-tie me-2 text-success"></i> Informasi Approver
                        </h6>
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-8 info-value">{{ $approval->divisi ?? '-' }}</div>
                        </div>
                        <div class="row mb-4 align-items-center">
                            <div class="col-sm-4 info-label">Jabatan</div>
                            <div class="col-sm-8 info-value">{{ $approval->position ?? '-' }}</div>
                        </div>

                        <!-- Section 2: Informasi Dokumen -->
                        <h6 class="text-uppercase fw-bold section-title mb-4 mt-5 border-bottom pb-2">
                            <i class="fas fa-file-alt me-2 text-success"></i> Informasi Dokumen
                        </h6>

                        <div class="row mb-3 align-items-center">
                            <div class="col-sm-4 info-label">Nama Dokumen</div>
                            <div class="col-sm-8 info-value">{{ $documentname ?? '-' }}</div>
                        </div>
                        <div class="row mb-3 align-items-center">
                        ...
                        <div class="mt-5 text-center">
                            @if(!empty($approval->signature))
                                <div class="mt-3">
                                    <img src="{{ asset($approval->signature) }}"
                                        alt="Tanda Tangan"
                                        class="img-fluid"
                            ...
                            @else
                                <div class="text-muted mb-3 mt-3">
                                    <em>Tanda tangan belum tersedia</em>
                                </div>
                            @endif

                            <h6 class="text-uppercase fw-bold section-title mb-3 border-bottom pb-2 d-inline-block">
                                <i class="fas fa-signature me-2 text-success"></i> Tanda Tangan
                            </h6>
                        </div>
