...
class AnswerParticipant extends Model
{
    use HasFactory;

    protected $table = 'answer_participants';
    protected $primaryKey = 'id';
    protected $fillable = ["type", "participant_id", "event_id", "user_id", "question_id", "answer_id", "point"];
